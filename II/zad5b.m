...
%     modelsPlotter(y_ucz, y_ucz_siec, y_wer, y_wer_siec, 't', 't', i);
%     ifYeqX_Plotter(y_ucz, y_ucz_siec, 'b', 'b', 'uczace', i);
%     ifYeqX_Plotter(y_wer, y_wer_siec, 'b', 'b', 'weryfikujace', i);
    i = i + 1;
end

best_neural_model = errors_container_OE(1);
plotter_from_uczenie_m(best_neural_model.wyjscie_uczenie_m.farx, best_neural_model.wyjscie_uczenie_m.foe, best_neural_model.wyjscie_uczenie_m.krok, best_neural_model.wyjscie_uczenie_m.ng, 'zad5', ['wyniki_K=', num2str(best_neural_model.K)]);
...
modelsPlotter(y_ucz, y_ucz_siec, y_wer, y_wer_siec, 'zad5', ['sygnalyY_K=', num2str(best_neural_model.K)], napis);
ifYeqX_Plotter(y_ucz, y_ucz_siec, 'zad5', ['porownanie_ucz_K=', num2str(best_neural_model.K)], 'uczace', napis);
ifYeqX_Plotter(y_wer, y_wer_siec, 'zad5', ['porownanie_wer_K=', num2str(best_neural_model.K)], 'weryfikujace', napis);